...
import adminEmailSettingsRoutes from './routes/admin/emailSettings';
...
import learnActivitiesRoutes from './routes/learnActivities';
...
app.use('/api/learn/activities', learnActivitiesRoutes);
